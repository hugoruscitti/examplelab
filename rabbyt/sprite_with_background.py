...
#image = rabbyt.pyglet_load_texture('shaolin.png')
#fat, size = rabbyt.load_texture('shaolin.png', size, type='RGBA', filter=True, mipmap=True)

sprite1 = Sprite(image, size)
sprite2 = Sprite('fat.png')

image, size = rabbyt.pygame_load_texture('big.png')
background = rabbyt.Sprite(image, size)
